...
export declare class IndexedDBStore extends MemoryStore {
    ...
    on: <T extends import("../models/typed-event-emitter.ts").EventEmitterEvents | keyof EventHandlerMap>(event: T, listener: import("../models/typed-event-emitter.ts").Listener<keyof EventHandlerMap, EventHandlerMap, T>) => TypedEventEmitter<keyof EventHandlerMap, EventHandlerMap, EventHandlerMap>;
    /**
