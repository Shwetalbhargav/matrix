...
import { LegacyRendezvousFailureReason as RendezvousFailureReason, RendezvousIntent } from "./index.js";
import { GET_LOGIN_TOKEN_CAPABILITY } from "../client.js";
...
export class MSC3906Rendezvous {
  ...
  startAfterShowingCode() {
    ...
    return _asyncToGenerator(function* () {
      ...
      var capabilities = {};
      try {
        capabilities = yield _this2.client.getCapabilities();
      } catch (e) {}
