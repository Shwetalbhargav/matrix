...
import { CrossSigningKey, DecryptionFailureCode, DeviceVerificationStatus, EventShieldColour, EventShieldReason, UserVerificationStatus } from "../crypto-api/index.js";
...
export class RustCrypto extends TypedEventEmitter {
  ...
  requestDeviceVerification(userId, deviceId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        var [request, outgoingRequest] = device.requestVerification(_this31._supportedVerificationMethods.map(verificationMethodIdentifierToMethod));
