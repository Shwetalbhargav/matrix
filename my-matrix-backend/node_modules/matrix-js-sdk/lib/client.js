...
import { Crypto, CryptoEvent, fixBackupKey, isCryptoAvailable } from "./crypto/index.js";
  ...
  joinRoom(roomIdOrAlias) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (opts.viaServers) {
        ...
        if (_this31.canSupport.get(Feature.MigrateServerNameToVia) === ServerSupport.Unstable) {
      ...
      var res = yield _this31.http.authedRequest(Method.Post, path, queryParams, data);
